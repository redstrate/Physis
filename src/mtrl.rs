...
impl Material {
    ...
    pub fn gear_material_path(gear_id: i32, gear_version: i32, material_name: &str) -> String {
        format!("chara/equipment/e{gear_id:04}/material/v{gear_version:04}{material_name}")
    }

    /// Builds a skin material path for a character
    pub fn skin_material_path(race_code: i32, body_code: i32, material_name: &str) -> String {
        format!(
            "chara/human/c{race_code:04}/obj/body/b{body_code:04}/material/v0001{material_name}"
        )
    }

    /// Builds a face material path for a character
    pub fn face_material_path(race_code: i32, face_code: i32, material_name: &str) -> String {
    ...
    pub fn hair_material_path(race_code: i32, hair_code: i32, material_name: &str) -> String {
        format!(
            "chara/human/c{race_code:04}/obj/hair/h{hair_code:04}/material/v0001{material_name}"
        )
    }

    /// Builds a ear material path for a character
    pub fn ear_material_path(race_code: i32, ear_code: i32, material_name: &str) -> String {
    ...
    pub fn tail_material_path(race_code: i32, tail_code: i32, material_name: &str) -> String {
        format!(
            "chara/human/c{race_code:04}/obj/tail/t{tail_code:04}/material/v0001{material_name}"
        )
    }
}
